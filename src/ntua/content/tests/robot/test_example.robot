...
#
#  $ bin/test -s ntua.content -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src ntua.content.testing.NTUA_CONTENT_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/ntua/content/tests/robot/test_example.robot
#
